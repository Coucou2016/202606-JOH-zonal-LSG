...
> **Burnett 30 折：分区没有帮忙。** 全局均值 1.7192 m，规则 1.8164 m，ΔRMSE = -0.0972 m，13/30 折，区间 [-0.2249, 0.0014]，`significant=false`。
...
| Burnett B=4 的 30 折 LOOCV | 13/30 | -0.0972 | [-0.2249, 0.0014] | 否（significant=false） |
...
| BurnettRV（12 事件单次划分） | 2.2323 | 1.6117 | 1.6122 | 全局 ≈ 分区，二者均改善 RMSE |
...
| 全局 | 1.6117 | 0.6317 | 4 | 强制 B=4（与分区等容量） |
| KMeans B=4 | 1.6122 | 0.6307 | 4 | 与规则几乎相同 |
| 规则 B=4 | 1.6122 | 0.6307 | 4 | 与 KMeans 数值重合 |
| 规则 B=8 | 1.6158 | 0.6263 | 8 | 略差于 B=4 |
| 全局 30 折均值 | 1.7192 | 0.6045 | 4 | 事件 LOOCV |
| 规则 30 折均值 | 1.8164 | 0.6408 | 4 | 13/30 折优于全局 |
